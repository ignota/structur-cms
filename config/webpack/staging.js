...
client.output
  ...
  .pathinfo(false)
  .publicPath('https://ass.ignota.fyi/')
  .hashFunction('sha256')
...
client
  .plugin('define')
    .tap(args => [
      merge(args[0], {
        __CABLE_URI__: JSON.stringify('wss://cable.ignota.fyi/'),
        __DEV__: JSON.stringify(false),
        __STRUCTUR_URI__: JSON.stringify('https://structur-api.ignota.fyi/'),
        __TRYSTERO_URI__: JSON.stringify('http://trystero.ignota.fyi'),
        __WHOMST_URI__: JSON.stringify('http://whomst-api.ignota.fyi'),
  ...
  .plugin('define')
    .tap(args => [
      merge(args[0], {
        __CABLE_URI__: JSON.stringify('wss://cable.ignota.fyi/'),
        __DEV__: JSON.stringify(false),
        __STRUCTUR_URI__: JSON.stringify('http://structur-api.staging/'),
        __TRYSTERO_URI__: JSON.stringify('http://trystero-api.staging'),
        __WHOMST_URI__: JSON.stringify('http://whomst-api.staging'),
        'process.env.NODE_ENV': JSON.stringify('staging'),
      }),
    ])
